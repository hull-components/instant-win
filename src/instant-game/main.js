/**
 *
 * A packaged instant_win game
 *
 * A instant_win is a game where the player finds out immediately if he or she is a winner of one of the prizes the administrators put at stake.
 *
 ...
 *
 * To create a instant_win, use the `admin/instant_win@hull` component which will let you create a instant_win and add prizes to it.
 *
 * @name instant_win
 * @param {String} id       Required, the instant_win achievement id.
 ...
 * @datasource {achievement} The instant_win achievement.
 * @datasource {badge}       The user's badge for the instant_win.
 * @tracking {start} instant_win Started
 * @example <div data-hull-component="instant-game"  data-hull-id="5134cd06c4748aba2400003c"></div>
 */
